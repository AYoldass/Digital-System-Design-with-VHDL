...
HD_PWD='C:/Users/ahmet/Desktop/PS2_Keyboard_UART/PS2_Keyboard_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_UART_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_UART_interface.tcl -notrace
