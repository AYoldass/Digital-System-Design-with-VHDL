...
HD_PWD='C:/Users/ahmet/Desktop/PS2_Keyboard_UART/PS2_Keyboard_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_UART_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_UART_interface.tcl
