...
HD_PWD='C:/Users/ahmet/Desktop/Digital-System-Design-with-VHDL/sram/sram/sram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_test.tcl -notrace
