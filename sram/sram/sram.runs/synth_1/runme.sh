...
HD_PWD='C:/Users/ahmet/Desktop/Digital-System-Design-with-VHDL/sram/sram/sram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_test.tcl
